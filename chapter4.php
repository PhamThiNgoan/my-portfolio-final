...
// === LOGIC THÊM SINH VIÊN (XỬ LÝ FORM POST) (TODO 2 - TODO 6) ===
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ten_sinh_vien'], $_POST['email'])) { 
    ...
    // TODO 6: Chuyển hướng về chính trang này để "làm mới"
    header('Location: chapter4.php'); 
    exit; 
}

// === LOGIC LẤY DANH SÁCH SINH VIÊN (SELECT) (TODO 7 & TODO 8) ===
...
<?php
// TODO 9 & 10: Dùng vòng lặp để duyệt qua kết quả và in các dòng <tr>
